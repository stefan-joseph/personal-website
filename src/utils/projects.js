...
import worldCollective from "../assets/images/world-collective.jpg";
const projects = [
  {
    id: 1,
  ...
  {
    id: 2,
    title: { one: "World_Collective", two: "UX DESIGN;" },
    text: "A mobile-responsive Next.js web app with a conntemporary and elegant UX design concept. Animations were done without external libraries  for efficiency using vanilla JS and React hooks",
    path: "https://world-collective.vercel.app/",
    img: worldCollective,
  },
  {
    id: 3,
